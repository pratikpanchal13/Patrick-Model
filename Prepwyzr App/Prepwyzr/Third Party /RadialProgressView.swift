...
class RadialProgressView: UIView {
    ...
    @IBInspectable var ringThickness:CGFloat = 6
    @IBInspectable var ringColor:UIColor = UIColor(red: 254/255, green: 159/255, blue: 0/255, alpha: 1)
    @IBInspectable var ringProgress:CGFloat = 1 {
        didSet {updateLayerProperties()}
    }
